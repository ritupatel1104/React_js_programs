    ...
    <>
      <section className='flex items-end justify-between w-full '>
        ...
        <div className='w-1/2 border border-gray-200 rounded-lg px-4 py-6 flex items-center justify-evenly max-w-xl'>
            ...
            {/* Text & Button */}
            <div className='w-1/2 flex flex-col justify-between items-start gap-y-25 '>
                ...
                <div>
                    ...
                    {/* svg icon */}
                        ...
                        <p className='text-[15px] font-semibold leading-5 py-2'>
            ...
            {/* chip 2 */}
            <div className='flex items-center justify-center gap-x-1 absolute z-10 text-[12px] bg-white px-2 py-1 border border-gray-200 rounded-full top-44 -left-6'>
              <CircleCheck  fill="green" className='text-white w-5 h-5 '/>
